  ...
  describe "Block" do
    ...
    context "returning values" do
      it "sets body from returning string" do
        ...
        expect(response.headers).to eq(rack_headers("Content-Length" => "11"))
      ...
      it "sets body from returnig enumerator" do
        ...
        expect(response.status).to  eq(200)
        expect(response.headers).to eq(rack_headers("Content-Length" => "8"))
      ...
      it "sets body from returning status" do
        ...
        expect(response.status).to  eq(200)
        expect(response.headers).to eq(rack_headers("Content-Length" => "2"))
      ...
      it "sets body and code from returning array" do
        ...
        expect(response.headers).to eq(rack_headers("Content-Length" => "7"))
      ...
      it "sets body and code from returning array with enumerator" do
        ...
        expect(response.status).to  eq(200)
        expect(response.headers).to eq(rack_headers("Content-Length" => "14"))
      ...
      it "sets body and code from returning serialized Rack response" do
        ...
        expect(response.headers).to eq(rack_headers("Content-Length" => "12", "X-Tea" => "White butterfly"))
      ...
      it "sets body and code from returning serialized Rack response with enumerator" do
        ...
        expect(response.status).to  eq(418)
        expect(response.headers).to eq(rack_headers("Content-Length" => "10", "X-Chunked" => "yes"))
    ...
    context "values" do
      ...
      it "sets status and enumerator" do
        ...
        expect(response.status).to  eq(200)
        expect(response.headers).to eq(rack_headers("Content-Length" => "13"))
      ...
      it "sets headers" do
        ...
        expect(response.status).to  eq(200)
        expect(response.headers).to eq(rack_headers("Content-Length" => "2", "X-Token" => "abc"))
        expect(response.body).to    eq("OK")
      end
      ...
      it "sets headers and body" do
        ...
        expect(response.status).to  eq(200)
        expect(response.headers).to eq(rack_headers("Content-Length" => "5", "X-Token" => "def"))
      ...
      it "sets headers and enumerator" do
        ...
        expect(response.status).to  eq(200)
        expect(response.headers).to eq(rack_headers("Content-Length" => "10", "X-Chunky" => "extra"))
    ...
    context "halting" do
      it "sets status and body from HTTP code" do
        ...
        expect(response.headers).to eq(rack_headers("Content-Length" => "12"))
      ...
      it "sets status and body from HTTP code and custom body" do
        ...
        expect(response.status).to  eq(401)
        expect(response.headers).to eq(rack_headers("Content-Length" => "18"))
      ...
      it "sets status and body from HTTP code and custom enumerator" do
        ...
        expect(response.headers).to eq(rack_headers("Content-Length" => "21"))
    ...
    context "json" do
      it "sets body and HTTP header" do
        ...
        expect(response.status).to  eq(200)
        expect(response.headers).to eq(rack_headers("Content-Length" => "11", "Content-Type" => "application/json"))
      ...
      it "sets body from enumerator and HTTP header" do
        ...
        expect(response.status).to  eq(200)
        expect(response.headers).to eq(rack_headers("Content-Length" => "19", "Content-Type" => "application/json"))
      ...
      it "sets body and HTTP header from given MIME type" do
        ...
        expect(response.status).to  eq(200)
        expect(response.headers).to eq(rack_headers("Content-Length" => "11", "Content-Type" => "application/vnd.api+json"))
    ...
    context "redirect" do
      it "sets status and HTTP header" do
        ...
        expect(response.headers).to eq(rack_headers("Content-Length" => "17", "Location" => "/home"))
      ...
      it "sets status and HTTP header from given HTTP code" do
        ...
        expect(response.headers).to eq(rack_headers("Content-Length" => "5", "Location" => "/home"))
      ...
      it "sets status and HTTP header from back" do
        ...
        expect(response.status).to  eq(301)
        expect(response.headers).to eq(rack_headers("Content-Length" => "17", "Location" => "/"))
        expect(response.body).to    eq("Moved Permanently")

        response = app.get("/redirect/back", "HTTP_REFERER" => "/foo", lint: true)

        expect(response.status).to  eq(301)
        expect(response.headers).to eq(rack_headers("Content-Length" => "17", "Location" => "/foo"))
        expect(response.body).to    eq("Moved Permanently")
      end
    end
